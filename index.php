...
if (empty($surname)) {// проверка на пустой ввод имени
...
echo "Отчество:" . PHP_EOL;
   ...
   if (empty($patronymic)) { // допускаю что можно ввести пустое отчество, тогда по разному выводим $fullName и  $surnameAndInitials
    $fullName = $surname.' '.$name;
    $surnameAndInitials = $surname .' '.  mb_substr($name, 0, 1, 'UTF-8').'.';
    }else {
